...
func NewMorpionController(bounds image.Rectangle, positionable canvas.Positionable) *Controller {
	return &Controller{
...
func (c *Controller) HandleGamepadEvent(event *controller.GamepadEvent, projection *controller.GamepadProjection) {
	if event.Name == "dpad" {
...
func (c *Controller) Update(elapsedBetweenUpdate time.Duration) bool {
