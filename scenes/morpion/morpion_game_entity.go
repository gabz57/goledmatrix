...
const (
	gameStateValue game.ValueRef = iota
	gameWinner
	exAequo
...
func (e *MorpionGameEntity) GetController() game.ControllerComponent {
	return &e.controller
}
...
func (e *MorpionGameEntity) Update(engine *game.Engine, dt time.Duration) bool {
	return false
}
...
func (e *MorpionGameEntity) startNewGame(engine *game.Engine) error {
	engine.GetEntity(menuEntityRef).(*MainMenuEntity).initializeMenu()
	e.initializeGame()
	return nil
}

func (e *MorpionGameEntity) moveCursorUp(engine *game.Engine) error {
...
func (e *MorpionGameEntity) moveCursorDown(engine *game.Engine) error {
	ref := e.GetValue(cursorPositionValue).(PositionRef)
	if ref <= 5 {
		e.SetValue(cursorPositionValue, ref+3)
		e.updateCellSelection(ref, ref+3)
...
func (e *MorpionGameEntity) moveCursorLeft(engine *game.Engine) error {
	ref := e.GetValue(cursorPositionValue).(PositionRef)
	if ref >= 1 {
...
func (e *MorpionGameEntity) moveCursorRight(engine *game.Engine) error {
	ref := e.GetValue(cursorPositionValue).(PositionRef)
	if ref <= 7 {
		e.SetValue(cursorPositionValue, ref+1)
		e.updateCellSelection(ref, ref+1)
...
func (e *MorpionGameEntity) pauseGame(engine *game.Engine) error {
...
func (e *MorpionGameEntity) selectPosition(engine *game.Engine) error {
